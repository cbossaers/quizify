...
namespace Quizify.Entities
{
    public class FabricaExamenes
    {
        ...
        int mostrar_resultados, List<int> preguntas, string estado, string dificultad, string CT = "")
        {
            return new Examen(id, titulo, descripcion, curso, autor, tiempo, fecha_creac, fecha_ini, fecha_fin, intentos,
            volver_atras, errores_restan, mostrar_resultados, preguntas, estado, dificultad, CT);
        }
    }
}